...
BATFISH_MAVEN_ARTIFACTS = [
    ...
    "com.fasterxml.jackson.datatype:jackson-datatype-guava:2.16.2",
    "com.fasterxml.jackson.datatype:jackson-datatype-jdk8:2.16.2",
    "com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.16.2",
    "com.fasterxml.jackson.jaxrs:jackson-jaxrs-base:2.16.2",
    "com.fasterxml.jackson.module:jackson-module-jaxb-annotations:2.16.2",
    ...
    maven.artifact(group = "org.glassfish.jersey.test-framework", artifact = "jersey-test-framework-core", version = "2.42", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
    maven.artifact(group = "org.glassfish.jersey.test-framework.providers", artifact = "jersey-test-framework-provider-grizzly2", version = "2.42", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
